...
def register_pixel_tools(mcp: object) -> None:
    ...
    def ua_get_pixels(
        ...
        """List pixels for an ad account. limit: defaults to 10 when omitted (TPA range 1-100)."""
    ...
    @mcp.tool(annotations=READ_ONLY_TOOL, structured_output=True)
    def ua_get_pixel_events(pixel_id: str) -> dict[str, Any]:
        """List events for a pixel."""
        return tool_response(api.call("get_pixel_events", pixel_id=pixel_id))
